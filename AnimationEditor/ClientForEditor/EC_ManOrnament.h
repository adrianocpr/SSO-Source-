...
public:		//	Operations
    ...
    bool IsHideAnimationModel() const;
	...
	DWORD LoadEffect(CECScene* pScene, AFileImage* pFile, float fOffX, float fOffZ);
	...
	DWORD LoadECModel(CECScene* pScene, AFileImage* pFile, float fOffX, float fOffZ);
	...
	DWORD LoadSoundObject(CECScene* pScene, AFileImage* pFile, float fOffX, float fOffZ);
