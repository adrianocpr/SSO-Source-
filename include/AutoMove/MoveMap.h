...
public:
	...
	CMultiCluGraph * CreateMultiCluGraph();
	...
	int      WhichLayer(const A3DPOINT2& ptMap, float dH) const;
	...
	static CMapGraph * GetMapGraph();
	static void        ReleaseMapGraph();
