...
int
getopt_long_only (argc, argv, optstring, longopts, longind, long_only)
	int argc;
	char *const *argv;
	const char *optstring;
	const struct option *longopts;
...
int
getopt_long (argc, argv, optstring, longopts, longind)
	int argc;
	char *const *argv;
	const char *optstring;
	const struct option *longopts;
	int *longind;
{
	return getopt_long_only (argc, argv, optstring,
		longopts, longind, 0);
}
