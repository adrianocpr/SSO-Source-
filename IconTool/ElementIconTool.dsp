...
# ADD CPP /nologo /MD /W3 /GR /GX /O2 /I "..\Include" /I "..\Include\stlport" /I "..\CCommon" /I "..\CElementClient\Network" /I "..\CElementClient\Network\IOLib" /I "..\CElementClient\Network\rpcdata" /I ".\include" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "UNICODE" /D "_AFXDLL" /YX /FD /c
...
# ADD CPP /nologo /MDd /W3 /Gm /GR /GX /ZI /Od /I "..\Include" /I "..\Include\stlport" /I "..\CCommon" /I "..\CElementClient\Network" /I "..\CElementClient\Network\IOLib" /I "..\CElementClient\Network\rpcdata" /I ".\include" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "UNICODE" /D "_AFXDLL" /Fr /YX /FD /GZ /c
...
# ADD LINK32 libpng.lib Dbghelp.lib vorbisfile_static_d.lib vorbis_static_d.lib ogg_static_d.lib d3d8.lib d3dx8.lib dsound.lib dxguid.lib AngelicaCommon_ud.lib Angelica3D_d.lib Immwrapper_d.lib mpg123lib_d.lib AngelicaFile_ud.lib zliblib.lib ElementSkill_d.lib /nologo /entry:"wWinMainCRTStartup" /subsystem:windows /debug /machine:I386 /nodefaultlib:"MSVCRT" /out:"..\CBin\ElementIconTool_d.exe" /pdbtype:sept /libpath:"..\Lib" /libpath:"..\Lib\IOLib" /libpath:"..\Lib\stlport" /libpath:".\lib"
