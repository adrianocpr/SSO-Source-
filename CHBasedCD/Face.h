...
public:
	...
	void SetVIDNum(int num) { m_arrVIDs.SetSize(0, num); }
	void SetEdgeHSNum(int num) { m_arrEdgeHSs.SetSize(0, num); }
	void SetExtraHSNum(int num) { m_arrExtraHSs.SetSize(0, num); }
