...
// ver.7: add region type to server file. add controller ID to server and client.
...
protected:	//	Attributes
	...
	int		m_nControllerID;	// new for ver.7
...
public:		//	Operations
	...
	int	GetControllerID(){ return m_iControllerID; }
...
public:		//	Types
	...
	typedef std::bitset<256> RegionStateVec;
...
public:		//	Operations
	...
	CELRegion* IsPointInRegion(float x, float z, RegionStateVec& vec);
	...
	CELRegion* IsPointInPKFreeRegion(float x, float z);
	//	Get region number
...
protected:	//	Attributes
	...
	abase::vector<CELRegion*>	m_aPKFreeRegions;	//	Freely PK region array
