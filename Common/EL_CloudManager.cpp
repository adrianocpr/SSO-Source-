...
{ 
	...
	if( !m_pTexture->LoadFromFile(pA3DDevice,_EA("textures\\cumulus01.tga"),1024,1024,A3DFMT_A8R8G8B8))
		return false;	
...
void CELCloudManager::ReFillStream(A3DViewport* pViewport)
{
	...
	if( !m_pStream->LockVertexBufferDynamic(0,m_nStreamVertices*sizeof(A3DTLVERTEX),(BYTE**)&pVertex,0) )
		return;
