...
void A3DAutoFirefly::ClampPosition (A3DTerrain2 * pTerrain, A3DTerrainWater2 * pTerrainWater, DWORD dwDeltaTime)
{
...
void A3DAutoFirefly::ClampAboveTerrainWater (A3DVECTOR3 pos, A3DTerrainWater2* pTerrainWater)
{
	// hard boundary
	A3DVECTOR3 vel = GetVelocity();
	float speed = vel.Magnitude();
