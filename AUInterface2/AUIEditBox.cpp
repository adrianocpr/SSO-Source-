...
bool AUIEditBox::IsRenderUnderLine()
{
	return (m_fStat) && (m_dwProperty & IME_PROP_AT_CARET) && (m_nLanguage != KOREAN);
}
...
int AUIEditBox::InsertCompStr(bool bResult)
{
	...
	int nLenOld = m_bMaxLenRendered ? a_strlen(GetText()) : m_szBuffer.GetLength();
