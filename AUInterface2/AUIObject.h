...
class AUIObject : protected Observer
{
public:
	typedef bool (* LPFRENDERHINTCALLBACK)(const POINT &pt, DWORD param1, DWORD param2, DWORD param3, DWORD param4);

public:
	AUIObject();
	virtual ~AUIObject();
	friend class GetAUISafeData;
	...
	*/
	...
	void SetChangeMan(AUIChangeManager* pChangeMan);
	void SetDataPtr(AUISafeData* pData,const AString& strKey);
	inline const AString GetDataKey(void){ return m_strSafeDataKey;}
	...
	void SetRenderHintCallback(LPFRENDERHINTCALLBACK pCallback,	DWORD param1, DWORD param2 = 0, DWORD param3 = 0, DWORD param4 = 0);
...
protected:
	...
	AUISafeData* GetDataPtr(const AString& strKey);
...
protected:
	...
	DWORD m_dwParamCallback4;
	LPFRENDERHINTCALLBACK m_pRenderHintCallback;

	DWORD m_dwData;
	UINT64 m_uiData64;
	UINT64 m_uiDataPtr64;
	AUIChangeManager* m_pChangeMan;

	AString m_strSafeDataKey;
